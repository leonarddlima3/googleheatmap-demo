function loadXMLDoc() {
    ...
    xmlhttp.open("POST", "https://predictive-modeler.ketoswebportal.com/api/geoinfo/markers?country=us");
    xmlhttp.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
    xmlhttp.send(JSON.stringify({ "metal_name": "Lead", "min_year": "2019", "max_year": "2019" }));
}
function myFunction(xml) {
    console.log("response received");
    let apiResponse = JSON.parse(xml.response);
    ...
    xmlhttp.open("GET", "https://maps.googleapis.com/maps/api/js?key=AIzaSyDWuv1TAG1Lz9VPpotJCLs0Yg3C5NzwJf0&libraries=visualization&callback=initMap");
    xmlhttp.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
